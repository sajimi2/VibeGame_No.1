...
用户澄清美术参考不照抄，土褐苔绿配色及修长比例未定，计划已修正。坡缘抖动已复现为圆柱底缘接触不稳定（单帧高度突跳最高约 1.12m）；移动碰撞和起身检测改用胶囊，战斗圆柱/顶部设计保持独立。56 条边缘轨迹零失败，最大单步高度变化 0.12222m（离边自然下落），原 20 项空间检查通过。详见 reports/HEIGHT_EDGE_FIX.md。

2026-09-16：用户确认所有地形测试无 bug，批准继续攻击/弹道与画面试验：960×540、12 朝向、水平斜转固定镜头、正交/弱透视对比。保存 height-lab-01 回退标签后开始下一轮。
