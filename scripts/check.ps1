...
$tests = @('weapon_choreography','atlas_pipeline','arrow_attachment','character_art','locomotion_art','rock_collision','guard_reaction','attack_motion','battlefield','guard_encounter','mission','short_level','camp_loop','space_combat','combat_polish')
